      ...
      >
        {(isCorporate
          ? [
              ...
              "Cопровождение международных сделок по покупке/продаже товар, услуг, долей компании и тд с целью минимизации санкционного риска",
          ...
          : [
              "Консультации по возможности покупки/продажи того или актива (товар, недвижимость, услуга) у иностранного контрагента",
