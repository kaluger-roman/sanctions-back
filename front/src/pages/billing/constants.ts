...
export const DEVICE_INFO =
  "Cчитается количество уникальных устройств, с которых заходил пользователь. Также пользователь не может одновременно находиться в 1 учетной записи одновременно с 3 устройств. При заходе с устройства будет всплывать предупреждение, что будет произведен выход с одного устройства и вход с другого";
